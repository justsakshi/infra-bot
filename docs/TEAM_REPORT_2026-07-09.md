...
**Tests created: 1 (ID 475859, PRECISE_LEADS, via live campaign 3325652 — results land in the sheet automatically ~30 min later). Credits spent: 1 of 92.** Four live attempts, each informative:
